...
CHUNK_SIZE = 376000 # Number of rows per chunk
...
DATASET_SIZE = 18794204 # Total size of the dataset (for small scale project only)
GRID_SIZE = 0.4 #Grid cell size for TASK C
SAVE_TO_CSV = True
LOAD_ALL = False #Loads all the data at once, consumes a lot of RAM
